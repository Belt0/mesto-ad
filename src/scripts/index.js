...
import { getUserInfo, getCardList, addNewCard, deleteCardFromServer, setUserAvatar, setUserInfo } from "./components/api.js";
...
const usersStatsModalTitle = usersStatusModalWindow.querySelector(".popup__title");
const usersStatsModalInfoList = usersStatusModalWindow.querySelector(".popup__info");
const usersStatsModalText = usersStatusModalWindow.querySelector(".popup__text");
const usersStatsModalUsersList = usersStatusModalWindow.querySelector(".popup__list");
...
const createInfoString = (term, description) => {
  ...
  const element = template.contentEditable.querySelector(".popup__info-item").cloneNode(true);
